    ...
    <div class="p-5">
        ...
        <form action="{{route('store')}}" method="POST" enctype="">
            ...
            <div class="mb-3">
                ...
                <input value="" type="text" class="form-control" id="" name="menuname">
            </div>

            <div class="mb-3">
                <label for="" class="form-label">Menu Description</label>
                <input value="" type="text" class="form-control" id="" name="menudesc">
            </div>

            <div class="mb-3">
                <label for="" class="form-label">Menu Date Added</label>
                <input value=""type="date" class="form-control" id="" name="menudate">
            </div>

            <div class="mb-3">
                <label for="" class="form-label">Price</label>
                <input value="" type="number" class="form-control" id="" name="menuprice">
            </div>

            <div class="mb-3">
                <label for="" class="form-label">Image</label>
                <input  type="file" class="form-control" id="" name="menuimg">
            </div>
